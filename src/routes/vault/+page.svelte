<script lang="ts">
  ...
  <div class="flex justify-center items-center min-h-screen bg-gray-100">
    <Card class="w-full max-w-[600px] m-4">
      <CardContent class="p-6">
                  ...
                  <div class="flex justify-between items-center">
                    ...
                    <div class="flex space-x-2 items-center">
                      {#if hoveredSite === index}
                        <div class="text-sm font-mono bg-gray-100 p-1 rounded">
        ...
        {:else if screen === 'addSite'}
          <div class="grid w-full items-center gap-4">
            ...
            <Button on:click={() => {newSite = { email: '', domain: '', rotationRounds: 1 }; editingSite = null; screen = 'main';}} variant="outline">Cancel</Button>
          </div>
  ...
  <div class="fixed bottom-4 right-4 flex space-x-2">
    <Button on:click={() => { $masterPassword = null; goto('/'); }} size="icon" variant="outline">
      <LogOut size={24} />
    </Button>
    <Button on:click={() => screen = 'settings'} size="icon" variant="outline">
      <Settings size={24} />
    </Button>
    <Button on:click={() => {editingSite = null; newSite = { email: '', domain: '', rotationRounds: 1 }; screen = 'addSite';}} size="icon">
      <Plus size={24} />
    </Button>
  </div>